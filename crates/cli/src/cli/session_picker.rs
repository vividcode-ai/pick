...
use crate::utils::tui_wrapper::{
    ExtendedSelectResult, read_single_key, run_extended_selector, show_session_preview,
};

/// Session loader function type
pub type SessionsLoader =
    Box<dyn Fn() -> futures::future::BoxFuture<'static, Vec<SessionInfo>> + Send + Sync>;
...
pub async fn select_session(
    ...
    loop {
        ...
        let result =
            run_extended_selector("Select Session", &sessions, render_session_item, scope_name);
